...
🔗 Compare:
https://github.com/devalltect00/Path-Header-Scanner/compare/v1.0.0...HEAD
...
- Add all eight names to the scanner's default ignored-directory contract.
- Extend scanner and developer-workflow regression coverage.

### Validation Intent

#### Dev

- Confirm supported files inside both environments are never scanned.
...
release • feature • bugfix • docs • tests • ci • build • stable • repository-cleanup • release-validation • documentation
